...
export function Profile() {
  const [platformSettingsData, setPlatformSettingsData] = useState([]);
  ...
  useEffect(() => {
    ...
    axios.get("/api/platform-settings")
      .then((response) => setPlatformSettingsData(response.data))
      .catch((error) => console.error("Error fetching platform settings:", error));

    // Fetch conversations
    axios.get("/api/conversations")
      .then((response) => setConversationsData(response.data))
