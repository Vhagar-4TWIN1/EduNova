              ...
              <div className="app-utilities col-auto">
                ...
                <div className="app-utility-item app-user-dropdown dropdown">
                  ...
                  <ul className="dropdown-menu" aria-labelledby="user-dropdown-toggle">
                    <li>
                      <a className="dropdown-item" href="account.html">Account</a>
                    </li>
                    <li>
            ...
            <ul className="app-menu list-unstyled accordion" id="menu-accordion">
                ...
                <div id="submenu-1" className="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                  <ul className="submenu-list list-unstyled">
                    <li className="submenu-item">
                      <a className="submenu-link" href="notifications.html">Notifications</a>
                    </li>
                    <li className="submenu-item">
                      <a className="submenu-link" href="account.html">Account</a>
                    </li>
                    <li className="submenu-item">
                      <a className="submenu-link" href="settings.html">Settings</a>
                    </li>
                  </ul>
                </div>
              </li>
              <li className="nav-item has-submenu">
                ...
                <div id="submenu-2" className="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
                  <ul className="submenu-list list-unstyled">
                    <li className="submenu-item">
                      <a className="submenu-link" href="login.html">Login</a>
                    </li>
                    <li className="submenu-item">
                      <a className="submenu-link" href="signup.html">Signup</a>
                    </li>
                    <li className="submenu-item">
                      <a className="submenu-link" href="reset-password.html">Reset password</a>
                    </li>
                    <li className="submenu-item">
                      <a className="submenu-link" href="404.html">404 page</a>
                    </li>
                  </ul>
                </div>
              </li>
