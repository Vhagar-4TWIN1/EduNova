...
const UsersBack = () => {
    ...
    const handleUserEdit = (user) => {
        setSelectedUser({ ...user }); // Reset selectedUser with the new user
    };
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            fetchUsers();
            setSelectedUser(null); // Reset the selectedUser state after updating
        } catch (err) {
    ...
    return (
        <div className="d-flex justify-content-center align-items-center" style={{ minHeight: '70vh', width: '100vw ' }}>
