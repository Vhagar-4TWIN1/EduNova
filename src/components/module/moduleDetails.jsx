...
import { FaCheckCircle, FaBook, FaPlus, FaArrowLeft, FaLock, FaLockOpen, FaTrash } from "react-icons/fa";
...
const ModuleDetails = () => {
  ...
  useEffect(() => {
    const fetchModuleLessons = async () => {
      try {
        const [moduleRes, lessonRes, enrollmentRes, completedRes] = await Promise.all([
  ...
  const handleDeleteLesson = async (lessonId) => {
    try {
      ...
      setLessons((prevLessons) => {
        ...
        const updatedCompleted = completedLessons.filter((id) => id !== lessonId);
    ...
    <div className="module-details-container">
      <div className="module-header">
        ...
        <div className="module-meta">
          ...
          <span className="module-difficulty">{module.difficulty || "All Levels"}</span>
        </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="lesson-content">
                    ...
                    <p className="lesson-excerpt">{lesson.content.substring(0, 100)}...</p>
