...
const CustomDivider = styled(Divider)({
  margin: "40px 0",
  background:
    "linear-gradient(to right, transparent, rgba(79, 165, 79, 0.3), transparent)",
  height: "2px",
  borderRadius: "1px",
});
...
const VideoWithFilters = styled("video")(
  ({ filter, brightness, contrast, transform, objectFit }) => ({
    width: "100%",
    height: "100%",
...
const UserProfile = () => {
  ...
  const filters = [
    ...
    { id: "sepia", name: "Sepia", filter: "sepia(100%)" },
    {
      id: "warm",
      name: "Warm",
      filter: "sepia(50%) saturate(1.5) hue-rotate(-10deg)",
    },
    { id: "cool", name: "Cool", filter: "saturate(1.5) hue-rotate(15deg)" },
    {
      id: "vintage",
      name: "Vintage",
      filter: "sepia(30%) contrast(110%) brightness(110%) saturate(85%)",
    },
  ];
  ...
  const frames = [
    { id: "none", name: "None", src: null },
    {
      id: "circle",
      name: "Circle",
      src: "data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iNTAwIiBoZWlnaHQ9IjUwMCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48Y2lyY2xlIGN4PSIyNTAiIGN5PSIyNTAiIHI9IjIzMCIgZmlsbD0ibm9uZSIgc3Ryb2tlPSJ3aGl0ZSIgc3Ryb2tlLXdpZHRoPSIyMCIvPjwvc3ZnPg==",
    },
    {
      id: "square",
      name: "Square",
      src: "data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iNTAwIiBoZWlnaHQ9IjUwMCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48cmVjdCB4PSI0MCIgeT0iNDAiIHdpZHRoPSI0MjAiIGhlaWdodD0iNDIwIiBmaWxsPSJub25lIiBzdHJva2U9IndoaXRlIiBzdHJva2Utd2lkdGg9IjIwIiByeD0iMjAiIHJ5PSIyMCIvPjwvc3ZnPg==",
    },
    {
      id: "heart",
      name: "Heart",
        ...
        if (response.data && response.data.data) {
          ...
          if (user.role === "Admin") {
            ...
            setTeacherData({
              ...
              cin: user.cin || "",
              workCertificate: user.workCertificate || "", // NEW
            });
            ...
            setStudentData({
              ...
              learningPreference: user.learningPreference || "video", // NEW
  ...
  const captureImage = () => {
    if (videoRef.current && canvasRef.current) {
      ...
      try {
        ...
        shutterSound
          .play()
          .catch((e) => console.log("Could not play shutter sound"));
      } catch (e) {
    ...
    try {
      ...
      if (userData.role === "Admin") {
        ...
        const teacherSpecificData = {
          ...
          cin: teacherData.cin,
          workCertificate: teacherData.workCertificate,
        };
      ...
      if (refreshResponse.data && refreshResponse.data.data) {
        ...
        if (refreshedUser.role === "Admin") {
          ...
          setTeacherData({
            ...
            cin: refreshedUser.cin || "",
            workCertificate: refreshedUser.workCertificate || "",
          });
      ...
      setError(
        "Error updating the profile. " + (error.response?.data?.message || "")
      );
          ...
          >
            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12}>
                ...
                />
                <HelperText>
                  Share your professional background and teaching philosophy
                </HelperText>
              </Grid>
              <Grid item xs={12}>
                <StyledTextField
              ...
              <Grid item xs={12}>
                ...
                />
                <HelperText>
                  List your relevant teaching and professional experience
                </HelperText>
              </Grid>
              ...
              <Grid item xs={12}>
                ...
                >
                  Upload Diplomas (multiple PDF files)
                  <input
                    hidden
                    type="file"
                    ...
                    onChange={(e) => {
                      ...
                      fetch("http://localhost:3000/api/users/upload-diplomas", {
                        ...
                        .then((res) => res.json())
                        .then((data) => {
                          const uploadedPaths = data.files || data.paths || [];
                          setTeacherData((prev) => ({
                            ...prev,
                            diplomas: Array.isArray(prev.diplomas)
                              ? [...prev.diplomas, ...uploadedPaths]
                              : [...uploadedPaths],
                          }));
                        })
                        .catch((err) =>
                      ...
                      fetch(
                        ...
                        .then((data) => {
                          if (data.path) {
                            setTeacherData((prev) => ({
                              ...prev,
                              workCertificate: data.path,
                            }));
                          }
                        })

                        .catch((err) =>
                          console.error("Work certificate upload error", err)
                        );
                    }}
                  />
                </Button>
            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12} sm={6}>
                <StyledSelectFormControl fullWidth>
                  ...
                  <StyledSelect
                    value={studentData.learningPreference || ""}
          ...
          {cameraError ? (
            ...
            <>
              <VideoPreviewContainer>
                ...
                <CaptureButton onClick={captureImage} disabled={!cameraReady}>
                ...
                {activeFrame && activeFrame !== "none" && (
                  <FrameOverlay
                    frame={frames.find((f) => f.id === activeFrame)?.src}
                  />
                )}
              </VideoPreviewContainer>
                  ...
                  {filters.map((filter) => (
                    ...
                    >
                      <LiveFilterPreview
                        ...
                        style={{
                          backgroundImage: filterPreviewImage
                            ? `url(${filterPreviewImage})`
                            : `url('data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMTAwIiBoZWlnaHQ9IjEwMCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48Y2lyY2xlIGN4PSI1MCIgY3k9IjUwIiByPSI0MCIgZmlsbD0iIzRmYTU0ZiIvPjwvc3ZnPg==')`,
                        }}
                      />
                      {activeFilter === filter.id && (
                        <ActiveFilterIndicator>✓</ActiveFilterIndicator>
                      )}
              ...
              {activeTab === "adjustments" && (
                <Box sx={{ padding: "0 16px" }}>
                  <Box sx={{ mb: 3 }}>
                    ...
                    >
                      <span style={{ marginRight: "8px" }}>☀️</span> Brightness:{" "}
                      {brightness}%
                    </Typography>
                    <AdjustmentSlider>
                      <Slider
                  ...
                  <Box>
                    <Typography
                      ...
                      sx={{ mb: 1, display: "flex", alignItems: "center" }}
                    >
                      <span style={{ marginRight: "8px" }}>🔆</span> Contrast:{" "}
                      {contrast}%
                    </Typography>
                    <AdjustmentSlider>
                      <Slider
