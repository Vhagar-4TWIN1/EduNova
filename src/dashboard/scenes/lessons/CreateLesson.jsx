  ...
  const CreateLesson = () => {
    ...
    const handleSubmit = async () => {
      ...
      try {
        ...
        console.error("❌ Error creating lessons:", err.response?.data || err.message);
    ...
    const renderFilePreview = (file) => {
      ...
      if (file.type.includes("video")) {
        return <video controls src={url} width="100%" style={{ borderRadius: 8 }} />;
      } else if (file.type.includes("image")) {
        return <img src={url} alt="preview" width="100%" style={{ borderRadius: 8 }} />;
      ...
      >
        ...
        <CardContent>
          <Stack spacing={4}>
            ...
            />
            <TextField
              label="Type of Lesson (video, pdf, audio, photo)"
              name="typeLesson"
